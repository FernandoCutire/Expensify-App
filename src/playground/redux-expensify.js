...
store.subscribe( () => {
 ...
 const expenseTwo = store.dispatch(addExpense({description: "Guitar", amount: 300, createdAt: 300}));

// store.dispatch(removeExpense({id: expenseOne.expense.id }));

// store.dispatch(editExpense(expenseTwo.expense.id , {amount: 500} ));

// store.dispatch(setTextFilter('guitar'));
...
//store.dispatch(setStartDate(0)); // startDate
// store.dispatch(setStartDate()); // startDate

//store.dispatch(setEndDate(100)); // EndDate
